...
<!--html_preserve--><div class="DiagrammeR html-widget html-fill-item" id="htmlwidget-fad8b2107289bd792675" style="width:504px;height:504px;"></div>
<script type="application/json" data-for="htmlwidget-fad8b2107289bd792675">{"x":{"diagram":"\n  graph LR\n    A[Input data] --> B[%T>%]\n    B --> C[Function run for side-effect <br> e.g. print, plot or log]\n    B --> E\n    C --> D[ %>% ]\n    D --> E[Next function in the flow]\n"},"evals":[],"jsHooks":[]}</script><!--/html_preserve-->
