...
<img src="fig/spatial_data_intro-rendered-unnamed-chunk-5-1.png" alt="" style="display: block; margin: auto;" />
...
``` error
Error in `h()`:
! error in evaluating the argument 'x' in selecting a method for function 'project': object 'world' not found
```
